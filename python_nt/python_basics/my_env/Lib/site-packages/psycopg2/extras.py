...
import library
from library import extensions as _ext
...
from library._psycopg import (                             # noqa
...
from library._ipaddress import register_ipaddress          # noqa
...
def wait_select(conn):
    ...
    """
    import select
    from library.extensions import POLL_OK, POLL_READ, POLL_WRITE
...
def execute_values(cur, sql, argslist, template=None, page_size=100, fetch=False):
    ...
    **not** contain a total result.
    ...
    '''
    from library.sql import Composable
